...
// calculus part (distance simple formulas)...
  ...
  unsigned long duree = pulseIn(echoPin, HIGH, 25000); // the "int" values, 25000 means the max time we should wait before this operation restart from the begining of the code...
